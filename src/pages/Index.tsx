            ...
            <header className="py-2 sm:py-3 px-2 border-b border-border/40 backdrop-blur-md bg-background/80 glass sticky top-0 z-50">
              <div className="flex items-center justify-between w-full">
                ...
                <div className="flex items-center gap-1 sm:gap-2 pr-1">
                  ...
                  <Button variant="ghost" size="icon" onClick={toggleTheme} className="rounded-full hover:bg-accent/80">
                    {theme === 'light' ? <Moon size={18} /> : <Sun size={18} />}
                  </Button>
                  
                  <Button variant="ghost" size="icon" className="rounded-full hover:bg-accent/80 hidden sm:flex">
                    <Info size={18} />
                  </Button>
